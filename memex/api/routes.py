...
def patch_note(note_id: str, body: NotePatch) -> dict:
    ...
    # An edit is allowed while a research run is in flight: the report lands in
    # its own note, and the run's only write here is `research_status` — the
    # two cannot overwrite each other (contracts.md).
    #
